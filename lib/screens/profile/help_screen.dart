...
class _HelpScreenState extends State<HelpScreen> {
  ...
  Widget _buildHeader(
      Color accentColor, Color primaryColor, String fontFamily) {
    return Container(
                    ...
                    child: isExpanded
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, qIndex) {
                              final question =
                                  (section['questions'] as List)[qIndex];
